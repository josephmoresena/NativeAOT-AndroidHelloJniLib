...
namespace HelloJniLib.Jni.Pointers
{
    public readonly struct JCharSequence : IEquatable<JCharSequence>
    {
        ...
        public static implicit operator JCharSequence(Span<Char> span) => new(span.AsIntPtr());
        public static implicit operator JCharSequence(ReadOnlySpan<Char> readonlySpan) => new(readonlySpan.AsIntPtr());
        ...
        public String AsString(Int32 length = 0) => this._value.AsString(length);
        #endregion
